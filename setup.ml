...
(* OASIS_START *)
(* DO NOT EDIT (digest: c936fecdd3ec3dd4645c5b9d64449a15) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_http_router", []))];
          ...
          ("test_monadic",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_monadic", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/bhoflack/http_router";
          synopsis = "Simple http_router for co_http.";
          description =
            Some
              [
                 OASISText.Para
                   "http_router is a router for http requests.  Requests can be coupled with handlers using a simple DSL."
              ];
          categories = [];
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/bhoflack/http_router.git";
                      src_repo_browser =
                        Some "https://github.com/bhoflack/http_router";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Http_router"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "http_router";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "test_http_router";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_http_router.ml"});
               Executable
                 ({
                     cs_name = "test_monadic";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_monadic.ml"});
               Test
                 ({
                     cs_name = "test_http_router";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_http_router"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_monadic"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "7ËISÚ(y\r0Z*°©`À\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
